...
PROJECT_DIR = "/home/ashriva/work/beyond_finger_printing/ankit/bfp_projects/design_of_experiments/experiments/"
RESULT_DIR = PROJECT_DIR+"/results/check_run_temp/"
...
if __name__ == '__main__':
    ...
    # Command arguments for scripts
    ## -man to manually specify the hyperparameters to fit a Gaussian process and then run the bayesian optimization
    ## -opt to choose the optimum hyperparameters to fit a Gaussian process and then run the bayesian optimization
    ## -bopt_only use the existing gaussian process and then run the bayesian optimization
    ...
    # Use the already fit gaussian models
    # Useful when trying for different aquisition functions
    ...
    # Else fit the gaussian process first
    else:
        ...
        if opt:
            ...
            print("manual:\t ", score, GP_stress.kernel.theta, GP_stress.noise)
        ...
        if opt:
            ...
            print("manual:\t ", score, GP_resist.kernel.theta, GP_resist.noise)
